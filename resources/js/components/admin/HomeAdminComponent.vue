<template>
    <div
        class="relative overflow-x-auto sm:rounded-lg max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
...
export default {
  setup() {
    ...
    onMounted(() => {
      let uri = 'http://127.0.0.1:8000/api/admin';
